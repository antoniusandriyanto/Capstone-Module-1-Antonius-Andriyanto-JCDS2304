        ...
        while True:
            ...
            if(menuTambah=='1'):
              while True:
                data_to_added=[]
                while True:
                    tambahNIM=input('Masukkan NIM Siswa (1001-9999) : ')
                    if tambahNIM.isdigit():
                        tambahNIM=int(tambahNIM)
                        if tambahNIM>1000 and tambahNIM<=9999:
                            exist=False
                            for i in nilai:
                                if tambahNIM == i['NIM']:
                                    exist=True
                            ...
                            print('Diharapkan menginput NIM dengan ketentuan numerik dari 1001 hingga 9999')
                    else:
                ...
                while True:
                    ...
                    if len(tambahSiswa) <= 30 and tambahSiswa.replace(' ', '').isalpha():
                        tambahSiswa=tambahSiswa.title()
                        break
                    else:
                        print('Diharapkan menginput nama siswa dengan menggunakan alphabetical dan maksimal 30 huruf')
                ...
                while True:
                    tambahKota=input('Masukkan Kota Siswa (isi alphabetical) : ')
                    if len(tambahKota) <= 30 and tambahKota.replace(' ', '').isalpha():
                        tambahKota=tambahKota.title()
                        break
                    else:
                        print('Diharapkan menginput nama kota dengan menggunakan alphabetical dan maksimal 30 huruf')
                ...
                while True:
                    data_to_added.append([tambahNIM, tambahSiswa, jenisKelamin, tambahKota, inputNilai])
                    header = ['NIM', 'Nama', 'Jenis Kelamin', 'Kota', 'Nilai']
                    ...
                    if hapusData.isdigit():
                        ...
                        for i in range (len(nilai)):
                            if nilai[i]['NIM']==hapusData:
                                header = ['NIM', 'Nama', 'Jenis Kelamin', 'Kota', 'Nilai']
                                dataShow = [[nilai[i]['NIM'], nilai[i]['Nama'], nilai[i]['Jenis Kelamin'], nilai[i]['Kota'], nilai[i]['Nilai']]]
                            ...
                            if not updateSiswa:
                                ...
                                while True:
                                    ...
                                    if checkerMenuUpdate.lower() == 'ya':
                                        updateBagian= input('Data yang ingin diupdate adalah (NIM/Nama/Jenis Kelamin/Kota/Nilai) : ')
                                        if updateBagian.upper() == 'NIM':
                                            newValueNIM = input('Masukkan NIM siswa (1001-9999) (update) : ')
                                            if newValueNIM.isdigit():
                                                newValueNIM=int(newValueNIM)
                                                if newValueNIM > 1000 and newValueNIM <= 9999:
                                                    nim_exists = False
                                                    for siswa in nilai:
                                                    ...
                                                    print('Maaf NIM hanya dapat diinput menggunakan numerikal dari 1001 hingga 9999')
                                            else:
                                            ...
                                            if len(newValueNama) <= 30 and newValueNama.replace(' ', '').isalpha():
                                        ...
                                        elif updateBagian.lower() == 'kota':
                                            newValueKota = input('Masukkan kota siswa (update) : ')
                                            if len(newValueKota) <= 30 and newValueKota.replace(' ', '').isalpha():
                                                oldKota = nilai[i]['Kota']
                                                newValueKota = newValueKota.title()
                                                nilai[i]['Kota'] = newValueKota
                                                print('Data berhasil diupdate')
                                                header = ['NIM', 'Nama', 'Jenis Kelamin', 'Kota', 'Nilai']
                                                dataShow = [[nilai[i]['NIM'], nilai[i]['Nama'], nilai[i]['Jenis Kelamin'], nilai[i]['Kota'], nilai[i]['Nilai']]]
                                                print(tabulate(dataShow, headers=header, tablefmt='grid',stralign='center'))
                                                ...
                                                if confirm_update.lower() == 'ya':
                                                    ...
                                                    nilai[i]['Kota'] = oldKota
                                                    print('Data batal diupdate')
                                                    break
                                            else:
                                                print('Diharapkan menginput kota siswa dengan menggunakan alphabetical dan maksimal 30 huruf')
